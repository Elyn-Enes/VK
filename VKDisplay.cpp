...
VKDisplay::VKDisplay( int width, int height, const std::string& title ) {
    ...
    if ( ! tinyobj::LoadObj( &attrib, &shapes, &materials, &err, "./_res/chaletVN.obj", NULL, true ) ) {
...
void VKDisplay::createLogicalDevice() {
    ...
    VKQueueFamilyIndices indices = VKQueueFamilyIndices::findQueueFamilies( physicalDevice, surface );
...
void VKDisplay::createSwapChain() {
    ...
    VKSwapChainSupportDetails swapChainSupport = VKSwapChainSupportDetails::querySwapChainSupport( physicalDevice, surface );

    VkSurfaceFormatKHR surfaceFormat = VKDisplay::chooseSwapSurfaceFormat( swapChainSupport.formats );
    VkPresentModeKHR presentMode = VKDisplay::chooseSwapPresentMode( swapChainSupport.presentModes );
...
void VKDisplay::createGraphicsPipeline() {
	auto vertShaderCode = readFile("./_res/vert.spv");
    auto fragShaderCode = readFile("./_res/frag.spv");
...
void VKDisplay::createCommandPool() {
    VKQueueFamilyIndices queueFamilyIndices = VKQueueFamilyIndices::findQueueFamilies( physicalDevice, surface );
...
void VKDisplay::createTextureImage() {
    ...
    stbi_uc* pixels = stbi_load("./_res/chalet.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
...
void VKDisplay::Update() {

}

bool VKDisplay::IsClosed() {
	return this->isClosed;
}

void VKDisplay::Clear( float r, float g, float b, float a ) {
